...
//TERCERA ELECCION, Secuencia de patrones 
  ...
  la direccion de memoria del arreglo modificado por el usuario, y esto se
...
//usuario los pasos a seguir 
    ...
    Serial.println("Y se verá representado como un led encendido en esa posicion, al finalizar el patrón");
    Serial.println("             0");
  	...
  	Serial.println("             0");
  	Serial.println("             0");
  	Serial.println("Nota 1: este proceso se repetirá indefinidamente hasta que no te lo permita el programa ");
    Serial.println("Cuando el programa le pregunte : si desea terminar ingrese 2, si desea continuar ingrese 1: ");
    Serial.println("Si usted ya ha terminado de registrar su patrón deberá ingresar el 2");
    Serial.println("Nota 2:En caso de equivocarse al dibujar el patrón, tendrá que repetir el proceso desde cero :)");
...
//el delay del usuario, la cantidad de patrones y los puertos(Ser,scrlk,rclk)
